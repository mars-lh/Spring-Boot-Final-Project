package com.project.java.project.springboot.config;
...
public class TokenFilter extends OncePerRequestFilter implements Filter {
    ...
    protected void doFilterInternal(final HttpServletRequest request,
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ") && !authorizationHeader.equals("Bearer Authorization: Bearer")) {
